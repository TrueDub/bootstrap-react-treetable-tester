...
import DataTableTester from "./tester/DataTableTester.jsx";
import TreeTableTester from "./tester/TreeTableTester.jsx";
import MultiHeaderTester from "./tester/MultiHeaderTester.jsx";
                ...
                <div>
                    <table className="table">
                        ...
                        <tr>
                            ...
                            <td>
                                <button className="btn btn-outline-primary"
                                        onClick={showMultiHeaderTable.bind(null)}>Multi-header
                                </button>
                            </td>
                        </tr>
                        </tbody>
